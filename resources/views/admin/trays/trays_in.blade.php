            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <a type="button"  href="{{url('/admin/trays_in')}}"><i class="fa fa-refresh" aria-hidden="true"></i></a>&nbsp&nbsp&nbsp
                        ...
                        <div class="col-lg-offset-1 col-lg-10">
                            ...
                            @if(count($articles)>0)
                              ...
                              <tr>
                                ...
                                <td class="td-actions">
                                @can('trays.tray_out')
                                <a href="{{ url('/admin/trays/'.$article->id.'/tray_out') }}" class="btn btn-success btn-sm">Generar Préstamo &nbsp;&nbsp; <i class="fa fa-clipboard"></i></a>
                                @endcan
                                </td>
                              </tr>
                            </tbody>
