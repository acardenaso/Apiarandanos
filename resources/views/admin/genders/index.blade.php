                ...
                <div class="box-body">
                    <h2>Generos Registrados</h2>
                      ...
                      <div class="col-lg-offset-1 col-lg-8">
                        ...
                        <div class="col-lg-3">
                          <a href="{{ url('/admin/genders/create') }}" class="btn btn-success">Agragar nuevo género&nbsp;&nbsp;<i class="fa fa-plus"></i></a> 
                        </div>
                      </div>
                        <div class="row">
                            ...
                            <table class="table table-hover">
                              ...
                              <tbody class="buscar">
                                ...
                                <tr>
                                  ...
                                  <a href="{{ url('/admin/genders/'.$gender->id.'/edit') }}" class="btn btn-xs btn-warning" data-toggle="tooltip" title="editar género"  ><i class="fa fa-pencil"></i></a>
